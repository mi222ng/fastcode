...
<dialog>
    <div class="main-popup">
      <h3 class="dialog-title">LMS사이트 사용자 페이지</h3>
      ...
      <div class="popup-content">
        ...
        <p>제작기간 : 2023.03.16 ~ 2023.04.13</p>
        <p>특징 : html, css, jquery, 라이브러리 활용 외 데이터베이스를 연동</p>
        <p>팀원 : 손*진, 오*경, 장*홍, <span class="point_color">박민지</span></p>
        <p>- 기획, 디자인, 구현은 각 페이지를 맡은 팀원이 담당하였습니다.</p>
        <p>- 과정 말기 작품으로 프론트와 백엔드를 연동했습니다.</p>
        <p>- <a href="http://mzeeyy.dothome.co.kr/fastcode/admin/login.php" class="point_color">관리자페이지</a> 바로가기</p>
      </div>
      <hr>
      <form>
